...
/*
 * On the basis of https://github.com/dceddia/create-react-app-customized.
 *
...
switch (process.argv[2]) {
  ...
  case 'build':
    rewireModule('react-scripts-ts/scripts/build.js', loadCustomizer('../config-overrides.prod'));
    break;
